...
final class RecordingStoreTests: XCTestCase {
    ...
    override func setUp() {
        ...
        testDir = FileManager.default.temporaryDirectory.appendingPathComponent("local-echo-test-\(UUID().uuidString)")
    ...
    func testTempRecordingURL() {
        ...
        XCTAssertTrue(url.lastPathComponent.hasPrefix("local-echo-recording-"))
        XCTAssertEqual(url.pathExtension, "wav")
    }
