...
public enum ModelCatalog {
    ...
    public static let speech: [Model] = [
        Model(id: "qwen3-asr-1.7b-8bit", name: "Qwen3 ASR 1.7B INT8", backend: .qwenASR,
              repository: "mlx-community/Qwen3-ASR-1.7B-8bit", approximateDownload: "~2,5 Go",
              sizeCategory: .heavy),
        Model(id: "parakeet-tdt-v3-mixed", name: "Parakeet TDT v3 Q4/Q8", backend: .parakeet,
              repository: "MarkChen1214/parakeet-tdt-0.6b-v3-MLX-Mixed-4bit8bit", approximateDownload: "~400 Mo",
              sizeCategory: .lightweight),
        Model(id: "qwen3-asr-1.7b-4bit", name: "Qwen3 ASR 1.7B Q4/Q8", backend: .qwenASR,
